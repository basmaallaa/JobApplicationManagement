...
{
    public class ReviewApplicationCommandHandler : IRequestHandler<ReviewApplicationCommand, JobApplicationResponseDto>
    {
        ...
        public async Task<JobApplicationResponseDto> Handle(ReviewApplicationCommand request, CancellationToken cancellationToken)
        {
