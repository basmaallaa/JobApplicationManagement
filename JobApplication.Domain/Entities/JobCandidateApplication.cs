...
namespace JobApplication.Domain.Entities
{
    public  class JobCandidateApplication
    {
        ...
        private static readonly Dictionary<JobApplicationStatus, JobApplicationStatus[]> AllowedTransitions = new()
        {
            ...
            // Cancelled is only reachable through Cancel(), never through UpdateStatus().
        ...
        public void UpdateStatus(JobApplicationStatus newStatus)
        {
            ...
            {
                throw new DomainException($"Cannot change status from '{JobApplicationStatus}' to '{newStatus}'."); 
            }
        ...
        public void Review()
        {
            UpdateStatus(JobApplicationStatus.UnderReview);
        }
        ...
        public void Cancel()
        {
            ...
            {
                throw new DomainException($"Cannot cancel an application in '{JobApplicationStatus}' status.");
            }
